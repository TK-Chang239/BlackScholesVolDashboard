...
CAPTIONS = {
    ...
    "P7": (
        ...
        "own market-implied forward — backed out of that expiry's at-the-money "
        "C − P, so a stale close on the underlying cannot masquerade as an "
        "arbitrage. Anything smaller than the combined bid–ask spread, or on a "
