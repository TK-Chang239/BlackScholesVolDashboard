...
CAPTIONS = {
    ...
    "P8a": (
        ...
        "at the last quoted vol. The thin grey lines are the individual trades; "
        "the blue line is their sum."
    ),
    "P8b": (
    ...
    "P8c": (
        ...
        "would narrow this histogram towards the answer the model wants. Each "
